...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NHRM_Admin_API.Model.ViewTableData", b =>
                {
                    b.Property<double?>("AnxietyDepressinon")
                        .HasColumnType("float");

                    b.Property<double?>("Breathlessness")
                        .HasColumnType("float");

                    b.Property<DateTime>("DateTimeRecorded")
                        .HasColumnType("datetime2");

                    b.Property<double?>("EcogStatus")
                        .HasColumnType("float");

                    b.Property<double?>("FluidDrain")
                        .HasColumnType("float");

                    b.Property<double?>("HealthSlider")
                        .HasColumnType("float");

                    b.Property<double?>("LevelOfPain")
                        .HasColumnType("float");

                    b.Property<double?>("Mobility")
                        .HasColumnType("float");

                    b.Property<double?>("QolPainDiscomfort")
                        .HasColumnType("float");

                    b.Property<double?>("SelfCare")
                        .HasColumnType("float");
                    ...
                    b.Property<double?>("UsualActivities")
                        .HasColumnType("float");

                    b.ToView("ViewTableData");
                });
            ...
            modelBuilder.Entity("NHRM_Admin_API.ViewModels.AlertModels.Alert", b =>
                {
                    ...
                    b.Property<DateTime>("DateTimeRaised")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("NHRM_Admin_API.ViewModels.AlertModels.AlertsLog", b =>
                {
                    b.Property<int>("AlertID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("NHRM_Admin_API.ViewModels.AlertModels.ViewAlerts", b =>
                {
                    b.Property<string>("AlertTitle")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("NHRM_Admin_API.ViewModels.CategoryMeasurementsView", b =>
                {
                    ...
                    b.ToTable("CategoryMeasurements");
                });
